...
with col2:
    st.markdown('<div class="ingex-header; font-size:50px;">INGENERO360AI <span style="font-weight:300; font-size:50px; color:#64748B;">| Digital Investment Engine</span></div>', unsafe_allow_html=True)
